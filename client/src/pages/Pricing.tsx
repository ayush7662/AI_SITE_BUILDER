...
const appPlans: Plan[] = [
  {
    ...
    features: ['10 Credits', 'Basic Support', 'Community Access'],
  },
  {
    id: 'pro',
    name: 'Pro',
    ...
    features: ['100 Credits', 'Priority Support', 'Faster Builds'],
  },
  {
    id: 'enterprise',
    name: 'Enterprise',
    ...
    features: ['500 Credits', 'Dedicated Support', 'Advanced Tools'],
  },
]
