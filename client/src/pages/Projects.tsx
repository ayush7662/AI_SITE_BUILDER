      ...
      <div className="flex items-center gap-4 px-4 py-2 border-b border-gray-800">
        ...
        <div className="flex items-center gap-3 ml-auto">
          <button
            onClick={saveProject}
            disabled={isSaving}
            className="bg-gray-800 px-3 py-1 flex items-center gap-2 rounded"
          >
            {isSaving ? (
          ...
          <Link
            ...
            target="_blank"
            className="bg-gray-800 px-3 py-1 rounded flex gap-2"
          >
          ...
          {project.isPublished && (
            <button
              onClick={copyLink}
              className="bg-green-600 px-3 py-1 rounded flex gap-2 items-center"
            >
              {copied ? (
                <>
          ...
          <button
            ...
            className="bg-indigo-600 px-3 py-1 rounded flex gap-2"
          >
            {project.isPublished ? (
              <EyeOffIcon size={16} />
            ) : (
