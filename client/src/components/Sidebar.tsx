...
try{
  ...
  return (
    <div className={`h-full max-w-sm rounded-xl bg-gray-900 border-gray-800 transition-all 
              ...
              if ('content' in message) {
                ...
                return (
                  <div key={msg.id} className={`flex items-start gap-3 ${isUser ? 'justify-end' : ''}`}>
                    ...
                    <div className={`max-w-[80%] p-2 px-4 rounded-2xl text-sm mt-5
                      ${isUser
