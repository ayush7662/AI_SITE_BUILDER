            ...
            messages: [
                {
                    role: 'system',
                    content:`
                    You are a prompt enhancement specialist. Take the user's website request and expand it into a detailed, comprehensive
    ...
    messages: [
        {
          ...
          -Make it responsive using Tailwind responsive classes(sm:,
          md:, lg:, xl:)
          - Use Tailwind animations and transitions (animate-*,
          transition-*)
          - Include all necessary meta tags
          - Use Google Fonts CDN if needed for custom fonts
          - Use placeholder images from https://placehold.co/600x400
          - Use Tailwind gradient classes for beautiful backgrounds
          - Make sure all buttons, card, and componenets use Tailwind styling
...
const session = await stripe.checkout.sessions.create({
  ...
  expires_at: Math.floor(Date.now() / 1000) + 30 * 60,   // Express in 30 minutes
});
